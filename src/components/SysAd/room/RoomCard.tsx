...
export default function RoomCard({ room, onView }: Props) {
  return (
    <div className="relative flex flex-col gap-2 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      ...
      {/* Action Button */}
      <button className="mt-auto rounded-lg bg-gray-100 px-4 py-2 text-sm text-gray-700 transition hover:bg-gray-200 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600" onClick={() => onView(room)} >
        View Details
      </button>
    </div>
  )
