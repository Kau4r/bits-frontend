            ...
            <div className="relative z-10 w-full max-w-md mx-4 bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="px-6 py-5 space-y-4">
                    ...
                    {eventDetails && (
                        <div className="bg-gray-700/50 rounded-lg p-4 space-y-3">
                            <div className="font-medium text-white">{eventDetails.title}</div>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    <div className="text-indigo-400 text-xs mb-1">TO</div>
                ...
                <div className="flex justify-end gap-3 px-6 py-4 bg-gray-800/50 border-t border-gray-700">
                    <button
                        onClick={onCancel}
                        disabled={isLoading}
                        className="px-4 py-2.5 text-gray-300 hover:text-white transition-colors font-medium disabled:opacity-50"
                    >
                        {cancelText}
                    </button>
                    <button
