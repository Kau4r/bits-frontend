...
export default function FilterBar({
  ...
  return (
    <div className="flex flex-wrap gap-4 mb-6" role="region" aria-label="Monitoring filters">
      {/* Room dropdown */}
      <div>
        <label htmlFor="room-filter" className="block text-sm font-medium mb-1 dark:text-gray-300">
          Room
        </label>
        <select
          id="room-filter"
      ...
      <div>
        <label id="status-filter-label" className="block text-sm font-medium mb-1 dark:text-gray-300">
          Status
        </label>
