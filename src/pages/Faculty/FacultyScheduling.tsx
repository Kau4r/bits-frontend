...
const FacultyScheduling = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex p-4 items-center justify-between bg-slate-800/80 border border-slate-700 shadow-sm">
        <h1 className="text-2xl font-bold text-white">Faculty Scheduling</h1>
        <button
